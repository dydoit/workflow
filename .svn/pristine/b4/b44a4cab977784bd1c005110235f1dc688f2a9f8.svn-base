...
// 切换用户
export function toggleUser(params) {
    return request({
        url:'manage/login/changeUserInfoForTest',
        method: 'get',
        tokenFlag:true,
        params:{...params}
    })
...
// 删除工单中的附件
export function delProAttach(params) {
    return request({
        url: '/flowable/workCenter/deleteAttachmentById',
        method: 'get',
        params:{...params},
        tokenFlag:true
    })
...
export function revokeProcess(params) {
    return request({
        url: '/flowable/workCenter/revokeProcess',
        method: 'get',
        params:{...params},
        tokenFlag:true,
    })
...
export function stopProcess(params) {
    return request({
        url: '/flowable/workCenter/stopProcess',
        method: 'get',
        params:{...params},
        tokenFlag:true,
    })
