<template>
      ...
      >
        ...
        <el-col :span="11">
          <el-form-item label="承办人" prop="acceptName">
            ...
            <span class="el-input" @click="showDrawer">请选择承办人</span>
          </el-form-item>
        </el-col>
        <el-col :span="11">
  ...
  <span>我来啦!</span>
    ...
    <find-drawer ref="findDrawer"></find-drawer>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      field118Action: "/uniflowApi/manage/tblmanageattachment/addAttachment",
      field118fileList: [],
      orderTypeOptions: [
        {
          label: "建设",
