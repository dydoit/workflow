...
export default {
  ...
  methods: {
    ...
    selectedAccept({deptName,deptCode,orgCode,orgCodeName,oa,name,phone}){ // 已选好承办人
      this.formData = {
        ...this.formData,
        acceptOa:oa,
        acceptName: name,
        ...
        acceptOrg: deptName, //  承办人单位名称
        acceptSiteCode:orgCode, // 承办部门code
        acceptOrgCode:orgCodeName, // 承办单位code
      }
