<template>
  <div>
    ...
    <template v-if="currentFormKey === 'WlbgFormKey4' || evaluationData.formKey === 'WlbgFormKey4'">
      ...
      <el-row :gutter="10">
        <el-form el="evalutionForm" :model="evaluationData" :rules="evaluationRules" size="small" label-width="120px" :disabled="currentFormKey!=='WlbgFormKey4'">
          <el-col :span="8">
...
export default {
  ...
  methods: {
    ...
    validate() {
      validateForms([this.$refs["elForm"],this.$refs["approveForm"],this.$refs['evalutionForm']]).then(()=>{
         submitForm()
