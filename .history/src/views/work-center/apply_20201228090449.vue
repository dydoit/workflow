    ...
    <el-row :gutter="15">
      <el-form ref="approveForm" :model="approveDatas" :rules="approveRules" label-width="120px">
        ...
        <el-col :span="10" v-if="currentFormKey === 'WlbgFormKey2'">
          <el-form-item label="请选择实施部门领导" class="is-required" prop="shishibumenOa" size="small">
            <el-select
              style="width: 100%"
              filterable
        ...
        <el-col :span="10" v-if="currentFormKey === 'WlbgFormKey1'">
          <el-form-item label="请选择审批人" size="small" class="is-required" prop="xuqiubumenOa">
            <el-select
              style="width: 100%"
    ...
    validate() {
      if(this.currentFormKey==='WlbgFormKey1') {
        ...
        validateForms([this.$refs['shishiForm'],this.$refs["approveForm"]]).then(()=>{
         ...
         validateForms([this.$refs["evaluationForm"],this.$refs["approveForm"]]).then(()=>{
           this.submitForm()
        }).catch(err => {console.log(err)})
      }else {
        validateForms([this.$refs["approveForm"]]).then(()=>{
