<template>
  <div>
    <el-table v-loading="loadFlag" :data="tableData" style="width: 100%" size="small">
      ...
      <el-table-column prop="systemSn" label="工单类别"> </el-table-column>
      <el-table-column prop="systemSn" label="接受待办时间"> </el-table-column>
      <el-table-column prop="lastApprover" label="上级审批人"> </el-table-column>
