      ...
      <el-table-column label="操作" width="150">
        <template slot-scope="scope">
          <el-button @click="handleClick(scope.row)" type="text" size="small"
            >跟踪</el-button
          >
          <el-button v-if="enableRevokeFlag==='0'" @click="handleClick(scope.row)" type="text" size="small"
            >撤回</el-button
          >
          <el-button v-if="enableStopFlag==='0'" @click="handleClick(scope.row)" type="danger" size="small"
            >终止</el-button
          >
        </template>
      </el-table-column>
