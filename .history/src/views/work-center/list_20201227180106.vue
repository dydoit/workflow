<template>
  <div class="work-list">
    ...
    <el-table v-loading="loadFlag" :data="tableData" style="width: 100%" size="small">
      ...
      <el-table-column prop="startTime" label="发起时间" width="160"> </el-table-column>
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          <el-button @click="handleClick(scope.row)" type="primary" size="small"
            >跟踪</el-button
          >
          <el-button v-if="scope.row.enableRevokeFlag==='0'" type="danger" size="mini"
            >撤回</el-button
          >
          <el-button v-if="scope.row.enableStopFlag==='0'"  type="danger" size="mini"
            >终止</el-button
          >
        </template>
      </el-table-column>
