        ...
        <el-col :span="11">
          <el-form-item class="is-required" label="请选择：" prop="approveFlag">
            <el-radio-group v-model="approveDatas.approveFlag"  @change="changeApprove">
              ...
              <el-radio :label="1" v-if="!(currentFormKey==='WlbgFormKey5' && hisFormDatas.filter(item=>item.formKey==='WlbgFormKey3'||item.formKey==='WlbgFormKey4').length > 0)&&currentFormKey!=='WlbgFormKey3'&&currentFormKey!=='WlbgFormKey1'">不同意</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col>
        <el-col :span="22">
