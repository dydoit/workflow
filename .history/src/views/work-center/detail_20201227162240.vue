<template>
  <div>
    ...
    <template v-if="currentFormKey === 'WlbgFormKey4' || evaluationData.formKey === 'WlbgFormKey4'">
      ...
      <el-row :gutter="10">
        <el-form disabled ref="evalutionForm" :model="evaluationData" :rules="evaluationRules" size="small" label-width="120px" :disabled="currentFormKey!=='WlbgFormKey4'">
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item prop="receiptTimelyScore" disabled>
              <span slot="label" class="auto-label"
                >回单及时性
                <el-popover
                  placement="top"
