          ...
          <el-table :data="attachmentList" border size="small">
            ...
            <el-table-column label="操作" width="150">
              <template slot-scope="scope">
                <el-button @click="handleSee(scope.row)" type="primary" size="small"
                  >预览</el-button
                >
                <el-button @click="handleSee(scope.row)" type="info" size="small"
                  >下载</el-button
                >
                 <el-button @click="handleSee(scope.row)" type="danger" size="small"
                  >删除</el-button
                >
              </template>
      </el-table-column>
