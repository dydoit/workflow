      ...
      >
        ...
        <el-col :span="11">
          <el-form-item label="申请人" prop="applyName">
            <el-input v-model="user.name" :disabled="true" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
        ...
        <el-col :span="11">
          <el-form-item label="投资金额(万元)" prop="investmentMoney">
            <el-input
              v-model.number="formData.investmentMoney"
        ...
        <el-col :span="11">
          <el-form-item label="效益金额(万元)" prop="profitMoney">
            <el-input
              v-model.number="formData.profitMoney"
          ...
          <el-form-item label="上传附件" prop="field118">
            ...
            >
              ...
              <span style="margin-left: 8px; font-size: 12px; color: #606266"
                >只能上传jpg/png/jpeg/xls/xlsx/doc/docx/pdf/ppt/pptx/rar/zip文件，且不超过5M</span
              >
            </el-upload>
          </el-form-item>
        </el-col>
        <el-col :span="22">
          <el-table :data="attachmentList" border size="small" v-loading="uploadFlag">
            <el-table-column
              label="序号"
              type="index"
              align="center"
        ...
        <el-col :span="24" class="btn-group">
          <el-form-item size="large">
            <el-button type="primary" @click="submitForm" :disabled="uploadFlag">提交</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      formData: {
        ...
        applySiteCode: "00440038487", // 申请人部门临时code
  ...
  methods: {
    filter1() {
      this.formData.investmentMoney = this.formData.investmentMoney.toFixed(4);
    },
    filter2() {
      this.formData.profitMoney = this.formData.profitMoney.toFixed(4);
    },
    waite() { // 上传过程中等待
